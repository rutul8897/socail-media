            ...
            <div class="card-body pt-4 p-3">
                <form method="POST" role="form text-left">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div>
                                    <input disabled wire:model="email" class="form-control" type="email"
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <button  wire:click.prevent="updateUser()" wire:loading.attr="disabled" type="submit" class="btn bg-gradient-dark btn-md mt-4 mb-4 mx-2">{{ 'Save Changes' }}</button>
                    </div>
                    {{-- <span wire:loading>Saving...</span> --}}

                </form>
            </div>
        {{-- <div wire:loading wire:target="updateUser" class="flex items-center justify-center w-full h-full">
