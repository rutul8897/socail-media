 <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
       ...
       {{--  <div class="col-lg-5 mb-lg-0 mb-4">
        ...
        <div class="">
          <div class="card">
            ...
            <div class="card-body p-3">
              <div class="chart">
                <canvas id="user-line" class="chart-canvas" height="300px"></canvas>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row mt-4">
        <div class="">
          <div class="card">
            ...
            <div class="card-body p-3">
              <div class="chart">
                <canvas id="post-line" class="chart-canvas" height="300px"></canvas>
              </div>
            </div>
          </div>
        </div>
  ...
  <script>
    var userMonths = {!! json_encode(array_keys($monWiseUsers)) !!};
    var userValues = {!! json_encode(array_values($monWiseUsers)) !!};
    var userMaxValue = {!! json_encode(max(array_values($monWiseUsers))) + 20 !!};

    var postMonths = {!! json_encode(array_keys($monWisePosts)) !!};
    var postValues = {!! json_encode(array_values($monWisePosts)) !!};
    var postMaxValue = {!! json_encode(max(array_values($monWisePosts))) + 10 !!};

    var userGraph = document.getElementById("user-line").getContext("2d");

    var gradientStroke1 = userGraph.createLinearGradient(0, 230, 0, 50);
    ...
    var gradientStroke2 = userGraph.createLinearGradient(0, 230, 0, 50);
    ...
    var postGraph = document.getElementById("post-line").getContext("2d");

    var gradientStroke1 = postGraph.createLinearGradient(0, 230, 0, 50);

    gradientStroke1.addColorStop(1, 'rgba(253,235,173,0.4)');
    gradientStroke1.addColorStop(0.2, 'rgba(245,57,57,0.0)');
    gradientStroke1.addColorStop(0, 'rgba(255,214,61,0)'); //purple colors

    var gradientStroke2 = postGraph.createLinearGradient(0, 230, 0, 50);
